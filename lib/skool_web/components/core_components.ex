defmodule SkoolWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        ...
        class={[
          ...
          "shadow-sm focus:border-zinc-400 focus:ring-0 sm:text-sm sm:leading-6"
        ]}
        multiple={@multiple}
        {@rest}
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SkoolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SkoolWeb.Gettext, "errors", msg, opts)
    end
  end
