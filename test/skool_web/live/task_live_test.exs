defmodule SkoolWeb.TaskLiveTest do
  use SkoolWeb.ConnCase

  import Phoenix.LiveViewTest
  import Skool.TasksFixtures

  @create_attrs %{completed_at: "2023-12-29T05:49:00Z", description: "some description"}
  @update_attrs %{completed_at: "2023-12-30T05:49:00Z", description: "some updated description"}
